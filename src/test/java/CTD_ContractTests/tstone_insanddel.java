	...
	private void insert_csperchars(String idstring, String TYPE, String CNO)
		...
		for (i = 1; i <= 9; i++) {
			...
			case 6:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + ", '1', 'EDU')");
				conn.commit();
			...
			case 7:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + ", 'ILL', 'OCC')");
				conn.commit();
			...
			case 8:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + ", 'UNE', 'EMPS')");
				conn.commit();
			...
			case 9:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + ", 'WID', 'MAR')");
				conn.commit();
