	...
	private void insert_csperchars(String idstring, String TYPE, String CNO)
		...
		for (i = 1; i <= 9; i++) {
			...
			case 1:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upcr")+ ")");
				conn.commit();
			...
			case 2:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upya")+ ")");
				conn.commit();
			...
			case 3:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upyf")+ ")");
				conn.commit();
			...
			case 4:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upym")+ ")");
				conn.commit();
			...
			case 5:
				...
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upyi")+ ")");
				conn.commit();
				inscsperchars(idstring, TYPE, CNO, 5);
				break;
				
			case 6:
				childTest = parentTest.createNode(prop.getProperty("insed_extent"));
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upie")+ ")");
				conn.commit();
				inscsperchars(idstring, TYPE, CNO, 6);
				break;
				
			case 7:
				childTest = parentTest.createNode(prop.getProperty("insoc_extent"));
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upio")+ ")");
				conn.commit();
				inscsperchars(idstring, TYPE, CNO, 7);
				break;
				
			case 8:
				childTest = parentTest.createNode(prop.getProperty("insem_extent"));
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upue")+ ")");
				conn.commit();
				inscsperchars(idstring, TYPE, CNO, 8);
				break;
				
			case 9:
				childTest = parentTest.createNode(prop.getProperty("insma_extent"));
				t.executeQuery(prop.getProperty("insert_csperchars_rcins") + "" + "(" + idstring + "" + prop.getProperty("upwm")+ ")");
				conn.commit();
				inscsperchars(idstring, TYPE, CNO, 9);
				break;
			}
	...
	private void upcspercharsfrom(String personalcharsidstring, String TYPE, String CNO, int i)
		...
		try {
			...
			case 4:
				...
				break;
			case 5:
				childTest = parentTest.createNode(prop.getProperty("upfrommet"));
				break;
			case 6:
				childTest = parentTest.createNode(prop.getProperty("upfromedu"));
				break;
			case 7:
				childTest = parentTest.createNode(prop.getProperty("upfromocc"));
				break;
			case 8:
				childTest = parentTest.createNode(prop.getProperty("upfromemp"));
				break;
			case 9:
				childTest = parentTest.createNode(prop.getProperty("upfrommar"));
				break;
			}
	...
	private String upcspercharsto(String personalcharsidstring, String TYPE, String CNO, int i)
		...
		try {
			...
			case 1:
				...
				s.executeQuery(prop.getProperty("pct_cd_rc_oneupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			case 2:
				childTest = parentTest.createNode(prop.getProperty("uptoab"));
				s.executeQuery(prop.getProperty("pct_cd_rc_twoupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			case 3:
				childTest = parentTest.createNode(prop.getProperty("uptofna"));
				s.executeQuery(prop.getProperty("pct_cd_rc_threeupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			case 4:
				childTest = parentTest.createNode(prop.getProperty("uptoinu"));
				s.executeQuery(prop.getProperty("pct_cd_rc_fourupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			case 5:
				childTest = parentTest.createNode(prop.getProperty("uptomet"));
				s.executeQuery(prop.getProperty("pct_cd_rc_fiveupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			case 6:
				childTest = parentTest.createNode(prop.getProperty("uptoedu"));
				s.executeQuery(prop.getProperty("pct_cd_rc_sixupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			case 7:
				childTest = parentTest.createNode(prop.getProperty("uptoocc"));
				s.executeQuery(prop.getProperty("pct_cd_rc_sevenupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			case 8:
				childTest = parentTest.createNode(prop.getProperty("uptoemp"));
				s.executeQuery(prop.getProperty("pct_cd_rc_eightupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			case 9:
				childTest = parentTest.createNode(prop.getProperty("uptomar"));
				s.executeQuery(prop.getProperty("pct_cd_rc_nineupdate") + "'" + personalcharsidstring + "'");
				conn.commit();
				break;
			}
