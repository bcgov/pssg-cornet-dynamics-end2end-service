...
public class Adapter extends extentreport {
	...
	public void transferreason() throws IOException {
		...
		Response res = given().body(bodypayload).header("Content-Type", "Application/json").when()
				.post(prop.getProperty("Transrea_da_edpt")).then()
	...
	public void da_disc_chg_reg() throws IOException {
		...
		Response res = given().header("Content-Type", "Application/json").body(bodypayload).when()
				.post(prop.getProperty("disc_chg_reg_da_edpt")).then()
	...
	public void da_disc_chg() throws IOException {
		...
		Response res = given().header("Content-Type", "Application/json").body(bodypayload).when()
				.post(prop.getProperty("disc_charg_da_edpt")).then()
	...
	public void da_trans() throws IOException {
		...
		Response res = given().header("Content-Type", "Application/json").body(bodypayload).when().post(prop.getProperty("trans_da_edpt")).then()
	...
	public void da_tstonea(String gender) throws IOException {
		...
		if (rc != null) {
			dy_rsrc=prop.getProperty("dy_rsrc").replaceAll("\\{code\\}", rc);
		}
		...
		Response res = given().header("Content-Type", "Application/json").body(bodypayload).when()
				.post(prop.getProperty("tdaedpt")).then().body(prop.getProperty("dypy_fn"), is(fn))
		...
		/*if (dynamicsadapter.get(prop.getProperty("src")) instanceof Integer) {
			int ir_c = (int) dynamicsadapter.get(prop.getProperty("dy_src"));
			request_rc = String.valueOf(ir_c);
		}*/
		
		String dy_src=(String) dynamicsadapter.get(prop.getProperty("dy_src"));

		Assert.assertEquals(dy_src, dy_rsrc);
	...
	public void da_at() throws IOException {
		...
		Response res = given().header("Content-Type", "Application/json").body(bodypayload).when()
				.post(prop.getProperty("act_da_edpt")).then()
	...
	public void da_loc() throws IOException {
		...
		Response res = given().header("Content-Type", "Application/json").body(bodypayload).when()
				.post(prop.getProperty("loc_da_edpt")).then()
	...
	public void da_stat() throws IOException {
		...
		Response res = given().header("Content-Type", "Application/json").body(bodypayload).when()
				.post(prop.getProperty("stat_da_edpt")).then()
